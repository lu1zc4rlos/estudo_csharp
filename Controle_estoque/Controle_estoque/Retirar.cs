...
namespace Controle_estoque {
    public partial class Retirar : Form {
        ...
        private void button1_Click(object sender, EventArgs e) {
            Produto produto = new Produto(txtNome.Text, Convert.ToInt32(txtRetirar.Text));

            if (!int.TryParse(txtRetirar.Text, out int quantidade)) {
            ...
            try {
                ...
                int novaQuantidade = quantidadeAtual - int.Parse(txtRetirar.Text);
